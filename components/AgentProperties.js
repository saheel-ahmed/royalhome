var AgentProperties = {
    ...
    <div class="container-fluid" style="margin-top: 20px;">
         ...
         <div class="col-sm-4 text-right">
                <a v-bind:href="'mailto:'+properties[0].Listing_Agent_Email" class="btn btn-sm btn-primary">Email</a>
                <a v-bind:href="'tel:'+properties[0].Listing_Agent_Phone" class="btn btn-sm btn-light">Call</a>
         </div>
         </div>
